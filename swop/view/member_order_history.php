    ...
    <div style="margin-top: 15px;">
        ...
        <div style="display:inline-block;width:986px;float:right;margin-bottom:30px;">
            <div>
                ...
                <div style="display:inline-block;padding:10px 15px 10px 15px;margin:1px 0px;font-weight: bold;background:#FFFFFF;color:#000000;border-left:2px solid #D92F19;border-top:2px solid #D92F19;border-right:2px solid #D92F19;position:relative;top:3px;">歷史訂單</div>
            </div>
                    ...
                    for($i = 0;$i<$len;$i++)
                    {
                        ...
                        for($j=0; $j<$len2; $j++)
                        {
                            ...
                            if($j == 0)
                            {
                                ...
                                if($this->order[$i]["cancel"])
                                {
                                    echo    '<div class="td" style="border-left:1px solid #D4D4D4;padding:10px;width:103px;"><img src="http://www.crazy2go.com/public/img/template/click_icon2.jpg" style="position:relative;top:4px;"> 交易取消</div>';
                                }
                                else
                                {
                                    echo    '<div class="td" style="border-left:1px solid #D4D4D4;padding:10px;width:103px;"><img src="http://www.crazy2go.com/public/img/template/click_icon.jpg" style="position:relative;top:4px;"> 交易成功 <br/><input class="add_evaluate" type="button" value="追加評價" seller="'.$this->order[$i]["name"].'" order="'.$this->order[$i]["goods"][$j]["order"].'" sn="'.$this->order[$i]["sn"].'"><br/><input class="check_logistics" type="button" value="查看物流" seller="'.$this->order[$i]["name"].'" sn="'.$this->order[$i]["sn"].'" order="'.$this->order[$i]["goods"][$j]["order"].'"></div>';
                                }
                            }
                            else
                            {
