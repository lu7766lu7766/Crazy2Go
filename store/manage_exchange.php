<?php 
    ...
    if(!empty($_SESSION['backend']['login_user'])){
        ...
        for($i = 0; $i < $len; $i++)
        {
            if($result[$i]['application_exchanges']>0)
            $all_order[]=array(
            ...
            <div id="body">
                ...
                <div id="body_right">
                    <?php
                        ...
                        echo "<tr><td name='fi_no'>ID</td><td name='sn'>訂單序號</td><td name='date'>建立日期</td><td name='total'>總花費</td><td>訂單狀態</td><td>付款狀態</td><td>運輸狀態</td><td>收貨狀態</td><td>有商品換貨</td><td>訂單細目</td><td>商品細目</td>";
                        ...
                        for($i = 0; $i < $len; $i++)
                        {
                            ...
                            echo "<td>".$application_exchanges[$all_order[$i]["application_exchanges"]]."</td>";
